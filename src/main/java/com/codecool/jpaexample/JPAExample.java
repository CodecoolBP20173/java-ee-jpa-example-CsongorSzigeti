...
public class JPAExample {
    ...
    public static void populateDb(EntityManager em) {
        ...
        Student student = new Student("Ödön", "odon@tokodon.hu", birthDate1, address,"32423432423", classBp2);
        ...
        Student student2 = new Student("Aladár", "ktyfl@gmail.com", birthDate2, address, "1212312312", classBp2);
